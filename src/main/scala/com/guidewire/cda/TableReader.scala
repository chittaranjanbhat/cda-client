...
//  sc.hadoopConfiguration.set("fs.s3a.aws.credentials.provider", "com.amazonaws.auth.DefaultAWSCredentialsProviderChain")
  ...
  sc.hadoopConfiguration.set("fs.s3a.access.key",secret.fields("gw_secret_key").convertTo[String])
  sc.hadoopConfiguration.set("fs.s3a.secret.key", secret.fields("gw_access_key").convertTo[String])
