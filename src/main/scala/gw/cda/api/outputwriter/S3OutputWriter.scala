...
import gw.cda.api.utils.S3ClientSupplierNoblr
...
//    if (!S3ClientSupplier.s3Client.doesBucketExistV2(this.outputURI.getBucket)) {
    if (!S3ClientSupplierNoblr.noBlrs3Client.doesBucketExistV2(this.outputURI.getBucket)) {
...
//    if (S3ClientSupplier.s3Client.doesObjectExist(this.outputURI.getBucket, this.outputURI.getKey)) {
    if (S3ClientSupplierNoblr.noBlrs3Client.doesObjectExist(this.outputURI.getBucket, this.outputURI.getKey)) {
...
//    S3ClientSupplier.s3Client.putObject(outputURI.getBucket, yamlPath, yamlString)
    S3ClientSupplierNoblr.noBlrs3Client.putObject(outputURI.getBucket, yamlPath, yamlString)
  }
}